...
const Footer = () => {
  return (
    <div className=''>
      <div className="create-post-wrapper px-4 xl:pr-0  my-8 max-w-[600px] text-center mx-auto text-white">
        ...
        <div className='mt-2 '><button type='submit' className='relative py-2 mx-auto px-6 pr-9 group rounded-3xl flex items-center bg-black hover:bg-[#131313c5]'>Contact Us
          <BsArrowRightShort className='absolute right-3 group-hover:translate-x-4 group-hover:rotate duration-300  group-hover:text-yellow-500' size={25} /></button></div>
      </div>
      <div className=" px-2 flex-col flex tablet:flex-row justify-center tablet:justify-between items-center py-6 text-white">
        <div className="">
          <ul className='flex gap-4 tablet:gap-5 md:gap-7 items-center justify-around'>
