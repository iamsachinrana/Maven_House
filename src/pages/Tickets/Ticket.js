    ...
    return (
        <>
            <div>
                ...
                <header className=" px-4 header-content flex flex-col place-content-around text-white">
                    <div className="header-wrapper">
                        <marquee direction="left" scrollamount="12" loop="1">
                            <h1 className="text-4xl tablet:text-[90px] md:text-[104px] text-center ">DANE COOK DANE COOK</h1>
                        </marquee>
                    </div>
                        ...
                        <div className="left-side backdrop-blur-md bg-[#00000059] items-center  md:flex gap-4 w-[500px] md:w-[573px] rounded-2xl p-3">
                            ...
                            <div className=" md:w-[24rem]">
                                ...
                                <p className="text-xs mt-1">Join Dane Cook on October 5th for his latest stand-up comedy event ‘Above It All’ filmed from his
                                    ...
                                    Mart...</p>
                                <button className="mt-3 font-bold text-black py-1 px-3 rounded-md bg-white" type="submit">Buy Ticket Now</button>
                            </div>
                        </div>
