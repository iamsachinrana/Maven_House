                                    ...
                                    <div className="mt-2 tablet:mt-5  grid lg:grid-cols-2 gap-1">
                                        <div className="mt-4 ">
                                            ...
                                            <div
                                                ...
                                                {form.ticketImage ? <img src={form.ticketImage} alt='' /> : <div className=' center flex-col absolute'>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div className="flex gap-2">
                                                <div
                                                    className="w-[250px] relative h-[180px] bg-gray-700 justify-center items-center flex flex-col border border-dashed border-gray-600"><img className='w-full h-full object-cover' src="/images/login/DRAKE.png" alt="" />
                                                    {form.gallaryImage ? <img src={form.gallaryImage} alt='' /> :
                                                        <div className=' center flex-col absolute'><label htmlFor='gallary-image' className="flex bg-gray-500 p-1 text-xs">select image </label>
                                                            <p className="text-xs text-center">(Recommended Max size: 2MB)</p>
                                                            <input id='gallary-image' type='file' onChange={handleImageUpload} name='gallaryImage' hidden />
                                                        </div>}
                                                </div>
                                                <div className="flex flex-col gap-3">
                                                    <div className="w-[60px] h-[30px] bg-slate-700 border border-dashed border-gray-600"><img className='w-full h-full object-cover' src="/images/login/DRAKE.png" alt="" /></div>
                                                    <div className="w-[60px] h-[30px] bg-slate-700 border border-dashed border-gray-600"><img className='w-full h-full object-cover' src="/images/login/DRAKE.png" alt="" /></div>
                                                    <div className="w-[60px] h-[30px] bg-slate-700 border border-dashed border-gray-600"><img className='w-full h-full object-cover' src="/images/login/DRAKE.png" alt="" /></div>
