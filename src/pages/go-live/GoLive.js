                ...
                <div className="w-[320px] tablet:w-[340px] md:w-[450px] max-w-[650px] blur-bg mt-10 tablet:mt-0 rounded-2xl tablet:p-10 p-5">
                    ...
                    <div className="">
                        <label htmlFor="currently">Link
                            <input value={notify.link} onChange={(e) => setNotify({ ...notify, link: e.target.value })} required id='currently' type="text" className='input-b ' />
                        </label>
                    </div>
                    <div className="grid grid-cols-2 mt-4 gap-6">
                        <button type='submit' onClick={(e) => sendPushNotification(e)} className='green'>Send</button>
                        <button type='submit' className='red'>Clear</button>
                    </div>
                </div>
