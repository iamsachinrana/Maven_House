...
const Doja_Cat = () => {
  ...
  return (
    <div>
      <div>
        <header className=" px-4 Doja_cat h_creater flex flex-col place-content-around text-white">
          <div className="header-wrapper">
            <marquee direction="left" scrollamount="12" loop="1">
              <h1 className="text-4xl tablet:text-[90px] md:text-[100px] font-semibold text-center ">DOJA CAT DOJA CAT DOJA CAT DOJA CAT</h1>
            </marquee>
          </div>
