...
const Lil_Nas_X = () => {
  ...
  return (
    <div>
      <div>
        <header className=" px-4 LIL_NAS_X h_creater flex flex-col place-content-around text-white">
          <div className="header-wrapper">
            <marquee direction="left" scrollamount="12" loop="1">
              <h1 className="text-4xl tablet:text-[90px] md:text-[100px] font-semibold text-center ">LIL NAS X LIL NAS X LIL NAS X</h1>
            </marquee>
          </div>
